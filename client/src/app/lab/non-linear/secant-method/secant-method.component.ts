...
@UntilDestroy()
@Component({
  selector: 'nml-secant-method',
  templateUrl: './secant-method.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SecantMethodComponent implements OnInit {
  ...
  inputForm: FormGroup = new FormGroup({
    ...
    x1: new FormControl<number | null>(DEFAULT_X1, [Validators.required]),
  ...
  get x1(): FormControl<number | null> {
    return this.inputForm.get('x1') as FormControl<number>;
  }
      ...
      this.inputForm.setValue(
        {
          ...
          x1: labSnapshot?.input?.['x1'] ?? DEFAULT_X1,
